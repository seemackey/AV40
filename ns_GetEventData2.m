...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  NO'C changed it so as to get rid of the 30000 division calculation to bring it into seconds
TimeStamp = double(fileInfo.MemoryMap.Data.TimeStamp(posEvent(end)));
