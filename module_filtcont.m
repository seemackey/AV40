function [cnt_arej, cnte, cntm, cntc, cntu, cntb] = module_filtcont(craw, newadrate, filtere, filteru, filtertype,fs);
...
cnte = zeros(size(craw));
cntu = zeros(size(craw));
