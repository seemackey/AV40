...
% samsung
aud_dir = '/Volumes/Samsung03/data/AV40/Peter/pt030/imported/Aud/';
vis_dir = '/Volumes/Samsung03/data/AV40/Peter/pt030/imported/Vis/';
...
audfile = 'pt030000016_analog_imported.mat'; % epoched file
audpath = fullfile(aud_dir,audfile);
visfile = 'pt030000020_analog_imported.mat'; 
...
for i = 1:length(selectedChannels)
    ...
    lfp1 = squeeze(epoched_data_aud.standard.csd(ch, :, :)); % Attend Auditory
    lfp2 = squeeze(epoched_data_vis.standard.csd(ch, :, :)); % Attend Visual
